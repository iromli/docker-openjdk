...
ARG GLIBC_DOWNLOAD_BASE_URL=https://github.com/sgerrand/alpine-pkg-glibc/releases/download

ENV LANG=en_US.UTF-8

RUN wget -q -O /etc/apk/keys/sgerrand.rsa.pub https://alpine-pkgs.sgerrand.com/sgerrand.rsa.pub \
    && wget -q $GLIBC_DOWNLOAD_BASE_URL/${GLIBC_VERSION}/glibc-${GLIBC_VERSION}.apk \
    && wget -q $GLIBC_DOWNLOAD_BASE_URL/${GLIBC_VERSION}/glibc-bin-${GLIBC_VERSION}.apk \
    && wget -q $GLIBC_DOWNLOAD_BASE_URL/${GLIBC_VERSION}/glibc-i18n-${GLIBC_VERSION}.apk \
